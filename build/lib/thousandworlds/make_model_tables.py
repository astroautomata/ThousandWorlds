...
PUBLIC_METHODS = {"conv_decoder", "coord_deeponet", "coord_mlp", "gplfr", "knn", "pca_gbt", "ppca_icm", "pca_mlp", "pca_ridge", "sfno", "train_mean"}
GENERATED_METRICS = ("rmse", "acc", "ramse", "energy_score", "spread_skill_ratio", "relative_rmse", "relative_acc", "relative_energy_score")
